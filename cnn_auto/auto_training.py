...
def run_training():
    ...
    train, train_label = input_auto_data.get_image(train_dir)

    train_batch, train_label_batch = input_auto_data.get_batch(train,
                                                          train_label,
                                                          IMG_W,
                                                          IMG_H,
                                                          BATCH_SIZE,
                                                          CAPACITY)
    train_logits = auto_model.inference(train_batch, BATCH_SIZE, N_CLASSES)
    train_loss = auto_model.losses(train_logits, train_label_batch)
    train_op = auto_model.trainning(train_loss, learning_rate)
    train__acc = auto_model.evaluation(train_logits, train_label_batch)
